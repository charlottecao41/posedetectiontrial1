# Modified HumanMAC with Xway loss

You need to include data file detailed in the old readme.me

Sadly, the results are currently not that promising, so this is a wip.
